...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(Registries.ITEM, Blood_and_Ferrum.MOD_ID);
    ...
    public static final DeferredHolder<Item, Item> POWERED_CRISTIAN_CROSS = ITEMS.register(
            "p_c_c", () -> new PoweredCristianCrossItem(new Item.Properties().durability(PoweredCristianCrossItem.MAX_USES).stacksTo(1))
    );

    public static final DeferredHolder<Item, Item> POWERED_ORTODOX_CROSS = ITEMS.register(
